...
data modify storage gui:main container.on_change set from storage gui:main marker.on_change 
data modify storage gui:main container.on_close set from storage gui:main marker.on_close 
...
execute store result score @s save run data get storage gui:main marker.save
execute store result score @s save+ run data get storage gui:main marker.save+
execute store result score @s load run data get storage gui:main marker.load
execute store result score @s load+ run data get storage gui:main marker.load+
